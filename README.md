...
Em desenvolvimento inicial — estrutura de pastas definida, adapters de
dados ainda não implementados.

## Sobre o uso de IA no desenvolvimento

Este projeto foi desenvolvido com apoio de IA (Claude Code, da Anthropic)
como ferramenta de programação em pareamento.
